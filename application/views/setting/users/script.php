...
<script>
    $(document).ready(function() {
        ...
        function load_user() {
            ...
            $.ajax({
                type: 'GET',
                url: '<?= base_url('setting/user/get_user') ?>',
                dataType: 'JSON',
        ...
        $('#btn-tambah').on('click', function(e) {
            ...
            $('#modal-label').html('Tambah Pengguna Baru')
            $('#addModal').modal('show')
        })
        ...
        table_menu.on('click', '#btn-edit', function(e) {
            ...
            $('#modal-label').html('Edit Pengguna')
            $('#addModal').modal('show')
        })
        ...
        $('#form-tambah').on('submit', function(e) {
            ...
            if (form_type == 'store') {
                var url = '<?= base_url('setting/user/store') ?>'
            } else {
                var url = '<?= base_url('setting/user/update') ?>'
            }
        ...
        function edit(id) {
            $.ajax({
                type: 'GET',
                url: '<?= base_url('setting/user/select/') ?>' + id,
                dataType: 'JSON',
                success: function(res) {
                    console.log(res)
                    $('#name').val(res.name)
