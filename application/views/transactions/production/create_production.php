			...
			<div class="row mt-4">
				<div class="col-12">
					<div class="card">
						...
						<div class="card-body">
							<form method="GET" action="<?= site_url('transaksi/produksi/create') ?>" class="form-inline">
						...
						<div class="card">
							...
							<div class="card-body">
								<div class="alert alert-warning alert-dismissible fade show mt-3 col-md-12" role="alert">
									...
									Pastikan data kebutuhan anda sesuai, jika tidak anda dapat memperbaharui pada Bill of Material (BOM)
									<button type="button" class="close" data-dismiss="alert" aria-label="Close">
										<span aria-hidden="true">&times;</span>
									</button>
								</div>
					...
					<div class="col-12 mt-2">
						<div class="card">
							<div class="card-header">
								...
								<h6 class="card-title">Komponen Biaya</h6>
							</div>
							<div class="card-body">
								...
								<div class="text-right">
									<a href="<?= site_url('transaksi/produksi/konversi/' . $order['trans_id']) ?>" class="btn btn-success"><i class="fa fa-arrow-alt-circle-right"></i> Lanjutkan Ke Produksi</a>
								</div>
							</div>
						</div>
					</div>
				...
				<?php if (!$bom) : ?>
					<div class="col-12 text-center">
						<p>Oops !! Bill Of Material Tidak Ditemukan</p>
					</div>
				<?php endif ?>
			</div>
		</div>
